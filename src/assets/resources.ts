export const lessons = [
  ...
  },
  {
    ...
    sections: [
      ...
      { type: "h3", content: "The Different Ways to Learn Songs" },
      {
        type: "p",
        content:
          "Videos, By ear, tabs, chord tabs, chord charts, standard notation,",
      },
      { type: "h3", content: "Youtube" },
      { type: "p", content: "Youtube" },
      { type: "h3", content: "Learning Songs By Ear" },
      { type: "p", content: "Learning songs by ear" },
      { type: "h3", content: "Tab" },
      { type: "p", content: "Tabs" },
      { type: "h3", content: "Chord Charts" },
      { type: "p", content: "Chord charts" },
      { type: "h3", content: "Standard Notation" },
      { type: "p", content: "Standard notation" },
    ],
  },
  {
    id: 7,
