...
export const realSongListRealDifficultyFlatArray = [
  ...
  },
  {
    ...
    songName: "1415G",
    songTip:
      "This progression contains four chords each played for four beats.",
    songKey: "G",
    songChords: "G C G D",
    songInstrument: "guitar",
    songDifficulty: "key-of-g-chords-easy",
  ...
  },
  {
    ...
    songKey: "D",
    songChords: "D G D Bm Asus2 G",
    songInstrument: "guitar",
    songDifficulty: "any-key-chords-easy",
  ...
  },
  {
    ...
    userId: 1,
    songName: "Something",
    songTip: "Theres a melody that walks up and down through the chords.",
    songKey: "",
  ...
  },
  {
    ...
    songInstrument: "bass",
    songDifficulty: "key-of-g-riffs-and-chord-progressions-easy",
  ...
  },
  {
    ...
    songInstrument: "bass",
    songDifficulty: "key-of-g-riffs-and-chord-progressions-hard",
  ...
  },
  {
    ...
    songName: "Second",
    songTip:
      "Use your middle finger for the first note and pinky for the second.",
    songKey: "G",
    songChords: "G2 (6th string 3rd fret), A2 (6th string 5th fret)",
    songInstrument: "guitar",
  ...
  },
  {
    ...
    songTip:
      "Use your pointer finger for the first note and pinky for the second.",
    songKey: "G",
    songChords: "G2 (6th string 3rd fret), A#/Bb2 (6th string 6th fret)",
    songInstrument: "guitar",
    songDifficulty: "intervals-g",
  ...
  },
  {
    ...
    songTip:
      "Use your middle finger for the first note and index finger for the second note.",
    songKey: "G",
    songChords: "G2 (6th string 3rd fret, B2 (5th string 2nd fret)",
    songInstrument: "guitar",
    songDifficulty: "intervals-g",
  ...
  },
  {
    ...
    userId: 1,
    songName: "Fourth",
    songTip: "Use your middle finger for the first and second note.",
    songKey: "G",
    songChords: "G2 (6th string 3rd fret), C3 (5th string 3rd fret)",
    songInstrument: "guitar",
    songDifficulty: "intervals-g",
  ...
  },
  {
    ...
    songTip:
      "Use your middle finger for the first note and pinky for the second.",
    songKey: "G",
    songChords: "G2 (6th string 3rd fret), D3 (5th string 5th fret)",
    songInstrument: "guitar",
    songDifficulty: "intervals-g",
  ...
  },
  {
    ...
    songTip:
      "Use your middle finger for the first note and index finger for the second note.",
    songKey: "G",
    songChords: "G2 (6th string 3rd fret), E3 (4th string 2nd fret)",
    songInstrument: "guitar",
    songDifficulty: "intervals-g",
  ...
  },
  {
    ...
    songName: "Seventh",
    songTip:
      "Use your middle finger for the first note and pointer finger for the second note.",
    songKey: "G",
    songChords: "G2 (6th string 3rd fret), F3 (4th string 3rd fret)",
    songInstrument: "guitar",
    songDifficulty: "intervals-g",
  ...
  },
  {
    ...
    songTip:
      "Use your middle finger for the first note and ring finger for the second note.",
    songKey: "G",
    songChords: "G2 (6th string 3rd fret), F#/Gb3 (4th string 4th fret)",
    songInstrument: "guitar",
    songDifficulty: "intervals-g",
  ...
  },
  {
    ...
    songName: "Octave",
    songTip:
      "Use your middle finger for the first note and pinky for the second note.",
    songKey: "G",
    songChords: "G2 (6th string 3rd fret), G3 (3rd string 5th fret)",
    songInstrument: "guitar",
    songDifficulty: "intervals-g",
  ...
  },
  {
    ...
    songTip: "The Long and Winding Road Verse Melody",
    songKey: "",
    songChords: "",
    songInstrument: "guitar",
    songDifficulty: "hard-melodies",
  ...
  },
  {
    ...
    songName: "My Girl",
    songTip:
      "The two sections of the riff are the same but for different chords.",
    songKey: "",
    songChords: "",
    songInstrument: "guitar",
    songDifficulty: "easy-riffs-and-licks",
  ...
  },
  {
    ...
    songTip: "Don't forget about the open strings.",
    songKey: "",
    songChords: "",
    songInstrument: "guitar",
    songDifficulty: "easy-riffs-and-licks",
